      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed text-lg max-w-3xl mx-auto">
            Protect your loved ones' future with comprehensive life insurance plans. 
            We offer expert guidance to help you choose the right coverage for financial security and peace of mind.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-gray-600 leading-relaxed text-lg space-y-6">
            <p>
              Life insurance is a vital part of financial planning, ensuring that your family is 
              financially supported in your absence. Our experts help you navigate through various 
              policies to find one that fits your needs and budget.
            </p>
            <p>
              Whether you are looking for term life, whole life, or specialized coverage, we provide 
              transparent advice and reliable support throughout the application process.
            </p>
          </div>
        </div>
      </section>
...
<section className="py-20 bg-gray-100">
  <div className="max-w-6xl mx-auto px-6">
    ...
    >
      Why Choose{" "}
      <span className="">Our Insurance Services</span>
    </motion.h2>
      ...
      <section className="py-20 bg-white text-center px-6">
        ...
        >
          ...
          <p className="text-[#26374A]  mb-8 text-lg">
            Talk to our insurance experts today and find a plan that secures your legacy.
          </p>
