      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed text-lg max-w-3xl mx-auto">
            Providing innovative IT solutions and professional technology services to streamline 
            business operations, improve efficiency, and enhance security.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-gray-600 leading-relaxed text-lg space-y-6">
            <p>
              Our IT services cover a broad spectrum including software development, cloud solutions, 
              IT infrastructure management, cybersecurity, and helpdesk support. We focus on 
              delivering solutions that are tailored to your business needs.
            </p>
            <p>
              With a team of certified IT professionals, we ensure businesses can leverage the 
              latest technology to improve performance, reduce costs, and stay ahead of competition.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-100 text-center px-6">
        ...
        >
          ...
          <p className="text-gray-800 mb-8 text-lg">
            Let us help your business leverage technology for growth, efficiency, and security.
          </p>
