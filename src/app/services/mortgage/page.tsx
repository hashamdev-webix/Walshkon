    ...
    <div className="bg-white">
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <ServiceBreadcrumb current="Mortgage" />
          ...
          <p className="text-gray-600 leading-relaxed text-lg max-w-3xl mx-auto">
            Simplifying your mortgage journey with expert guidance, tailored
            solutions, and reliable support. Helping you secure the best home or
            property loans in Canada.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-gray-600 leading-relaxed text-lg space-y-6">
            <p>
              Our mortgage services help individuals and families navigate the
              complex process of securing property loans. From first-time
              homebuyers to investors, we provide expert advice and personalized
              solutions.
            </p>
            <p>
              We guide you through interest rates, loan options, approvals, and
              documentation, ensuring a smooth, stress-free experience.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <motion.h2
            ...
            className="text-3xl md:text-5xl font-extrabold text-center mb-14 text-[#26374A]"
          >
            Benefits of <span className="">Choosing Us</span>
          </motion.h2>
      ...
      <section className="py-20 bg-white text-center px-6">
        ...
        >
          ...
          <p className="text-gray-800 mb-8 text-lg">
            Partner with our mortgage experts and get the ideal financing
