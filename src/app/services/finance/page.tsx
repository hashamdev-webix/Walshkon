    ...
    <div className="bg-white">
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <ServiceBreadcrumb current="Finance" />
          ...
          <p className="text-gray-600 leading-relaxed text-lg max-w-3xl mx-auto">
            Professional financial solutions for individuals and businesses.
            From planning and investment to loans and risk management, we help
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-gray-600 leading-relaxed text-lg space-y-6">
            <p>
              Our finance experts provide personalized strategies to manage your
              wealth, optimize investments, and plan for the future. We combine
              industry knowledge with client-centric solutions for maximum
              benefit.
            </p>
            <p>
              We assist in budgeting, tax planning, retirement planning, loans,
              and investment management to ensure financial stability and
              growth.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            Benefits of <span className="">Our Finance Services</span>
          </motion.h2>
      ...
      <section className="py-20 bg-white text-center px-6">
        ...
        >
          ...
          <p className="text-[#26374A] mb-8 text-lg">
            Contact our finance experts to create a solid plan for investments,
