      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed text-lg max-w-3xl mx-auto">
            Grow your brand online with targeted strategies, expert campaigns, and measurable results. 
            We help businesses reach the right audience and drive real engagement.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-gray-600 leading-relaxed text-lg space-y-6">
            <p>
              Our digital marketing services are designed to increase visibility, generate leads, and improve conversions. 
              We combine creativity with data-driven strategies to help your business grow online.
            </p>
            <p>
              With experience across SEO, social media, PPC, email marketing, and content marketing, 
              our team ensures every campaign aligns with your brand and delivers measurable results.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-100 text-center px-6">
        ...
        >
          ...
          <p className="text-[#26374A] mb-8 text-lg">
            Partner with our digital marketing experts to drive traffic, generate leads, and grow your brand online.
          </p>
