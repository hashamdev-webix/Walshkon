      ...
      <section className="relative py-24 text-center bg-gradient-to-b from-gray-50 to-white">
        ...
        >
          <motion.h1
            ...
            className="text-5xl font-extrabold tracking-tight mb-6 text-[#26374A] "
          >
          ...
          >
        Expert legal assistance for Indians dealing with India-related matters, including property, family, and business legalities. Simplifying complex Indian legal processes for individuals and organizations.
          </motion.p>
        </motion.div>
      </section>
      {/* ================= CORE SERVICES ================= */}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed text-lg">
            We specialize in providing legal services exclusively for Indian clients on matters relating to India.
            Our experienced lawyers and legal consultants handle property disputes, family cases, business agreements,
            and more. We ensure transparency, accuracy, and timely advice tailored to your specific situation.
          </p>
        </div>
      </section>
...
<section className="py-20 bg-gray-100">
  <div className="max-w-6xl mx-auto px-6">
    ...
    >
      Why Choose Our{" "}
      <span className="">Legal Services</span>
    </motion.h2>
