      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed text-lg max-w-3xl mx-auto">
            Your trusted real estate partner for buying, selling, or renting homes. Expert guidance, 
            reliable listings, and smooth transactions for every client.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-gray-600 leading-relaxed text-lg space-y-6">
            <p>
              We specialize in helping clients buy, sell, and rent residential and commercial properties. 
              Our team ensures a transparent, smooth, and professional process at every step.
            </p>
            <p>
              From property valuation to finalizing deals, we provide expert assistance to make your 
              real estate experience stress-free and rewarding.
            </p>
          </div>
        </div>
      </section>
...
<section className="py-20 bg-gray-100">
  <div className="max-w-6xl mx-auto px-6">
    ...
    >
      Benefits of{" "}
      <span className="">Working With Us</span>
    </motion.h2>
      ...
      <section className="py-20 bg-white text-center px-6">
        ...
        >
          ...
          <p className="text-[#26374A] mb-8 text-lg">
            Contact our real estate experts to buy, sell, or rent properties efficiently and safely.
          </p>
