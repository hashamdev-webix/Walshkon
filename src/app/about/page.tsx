...
//     "Recruitment & Workforce Solutions",
//     "IT & Digital Services",
//     "Real Estate Advisory (Buy, Sell & Rent)",
//   ];
...
//               >
//                 Walshkon Consultants is a trusted multi-service consulting firm
//                 delivering professional solutions across business advisory, legal
//                 services, recruitment, IT, real estate, finance, and digital
//                 growth. We support individuals, professionals, and businesses
//                 with expert guidance, transparent processes, and results-driven
//                 strategies.
...
//                   <p className="mt-3 text-gray-800 text-lg">
//                     Our experienced team delivers customized solutions based on
//                     your unique goals. From business advisory and legal
//                     documentation to recruitment, IT solutions, and property
//                     advisory — we handle the complexity so you don’t have to. We
//                     believe in long-term relationships, not one-time
//                     transactions. Every client receives dedicated attention,
...
//               <p className="text-gray-800 text-sm leading-8 mb-6">
//                 End-to-end consulting support for corporate strategy, business
//                 operations, compliance, and enterprise planning. Our experts
//                 handle documentation assessment, advisory filings, and structured
//                 execution to ensure seamless growth.
//               </p>
...
//                 of attorney, attestations, and compliance-related matters. We
//                 ensure accuracy, confidentiality, and legal validity while
//                 supporting individuals and businesses with cross-border legal
//                 requirements.
//               </p>
...
//               <p className="text-[#26374A] text-[16px] leading-8">
//                 “Walshkon Consultants handled our corporate advisory and legal
//                 documentation with precision. Their team explained everything
//                 clearly and ensured a smooth and stress-free process. Truly
//                 reliable professionals.”
//               </p>
...
export default function AboutPage() {
  ...
  const data = [
    "Strategic Business & Management Consulting",
    "Paralegal Services (India & Canada-related matters)",
    "Recruitment & Workforce Solutions",
    "IT & Digital Services",
    "Real Estate Advisory (Buy, Sell & Rent)",
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col">
              ...
              >
                Walshkon Consultants is a trusted multi-service consulting firm
                delivering professional solutions across business advisory, paralegal
                services, recruitment, IT, real estate, finance, and digital
                growth. We support individuals, professionals, and businesses
                with expert guidance, transparent processes, and results-driven
                strategies.
              ...
              >
                ...
                <div className="w-[600px] h-[300px] rounded-lg bg-gray-200 p-4">
                  ...
                  <p className="mt-3 text-gray-800 text-lg">
                    Our experienced team delivers customized solutions based on
                    your unique goals. From business advisory and paralegal
                    documentation to recruitment, IT solutions, and property
                    advisory — we handle the complexity so you don’t have to. We
                    believe in long-term relationships, not one-time
                    transactions. Every client receives dedicated attention,
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-gray-100 rounded-[28px] p-6 text-center shadow-sm hover:shadow-md transition flex flex-col">
              <h3 className="text-2xl font-extrabold leading-snug text-gray-900 mb-4">
                Paralegal <span className="text-[#26374A]">Services</span>
              </h3>

              <p className="text-gray-700 text-sm leading-8 mb-6">
                Reliable paralegal assistance for documentation, affidavits, power
                of attorney, attestations, and compliance-related matters. We
                ensure accuracy, confidentiality, and statutory validity while
                supporting individuals and businesses with cross-border procedural
                requirements.
              </p>

              <img
                src="https://images.unsplash.com/photo-1562564055-71e051d33c19?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fExlZ2FsJTIwU2VydmljZXN8ZW58MHx8MHx8fDA%3D"
                alt="Paralegal Services"
                className="w-full h-56 object-cover rounded-[24px] border border-red-300 mt-auto"
              />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-200 rounded-[28px] p-8 shadow-md">
              ...
              <p className="text-[#26374A] text-[16px] leading-8">
                “Walshkon Consultants handled our corporate advisory and paralegal
                documentation with precision. Their team explained everything
                clearly and ensured a smooth and stress-free process. Truly
                reliable professionals.”
              </p>
