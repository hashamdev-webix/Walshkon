      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            >
              Walshkon Consultants is a trusted multi-service consulting firm delivering professional solutions across immigration, legal services, recruitment, IT, real estate, finance, and digital growth. We support individuals, professionals, and businesses with expert guidance, transparent processes, and results-driven strategies.
            </motion.p>
            ...
            <motion.div 
              ...
              className="mt-10"
            >
              <h1 className="text-4xl font-extrabold ">What We Specialize In</h1>
...
<h2 className="text-gray-600 font-extrabold text-2xl">Why Choose Us?</h2> 
<p className="mt-3 text-gray-800 text-lg">Our experienced team delivers customized solutions based on your unique goals. From immigration filings and legal documentation to recruitment, IT solutions, and property advisory — we handle the complexity so you don’t have to. We believe in long-term relationships, not one-time transactions. Every client receives dedicated attention, reliable guidance, and clear communication throughout the process.</p>
              </div>
            </motion.div>
          </div>
...
<div className="bg-gray-100 rounded-[28px] p-6 text-center shadow-sm hover:shadow-md transition flex flex-col">
  ...
  <p className="text-gray-800 text-sm leading-8 mb-6">
    ...
    follow-ups to ensure a smooth and successful immigration process.
  </p>
...
<div className="bg-gray-100 rounded-[28px] p-6 text-center shadow-sm hover:shadow-md transition flex flex-col">
  ...
  <p className="text-gray-700 text-sm leading-8 mb-6">
    Reliable legal assistance for documentation, affidavits, power of
    attorney, attestations, and compliance-related matters. We ensure
    accuracy, confidentiality, and legal validity while supporting
    individuals and businesses with India-related legal requirements.
  </p>
...
<div className="bg-gray-100 rounded-[28px] p-6 text-center shadow-sm hover:shadow-md transition flex flex-col">
  ...
  <p className="text-gray-700 text-sm leading-8 mb-6">
    Strategic recruitment solutions connecting skilled professionals with
    trusted employers. We manage candidate screening, interviews, and
    placements while helping businesses build strong teams and assisting
    job seekers in finding suitable career opportunities.
  </p>
...
<div className="bg-gray-100 rounded-[28px] p-6 text-center shadow-sm hover:shadow-md transition flex flex-col">
  ...
  <p className="text-gray-700 text-sm leading-8 mb-6">
    Comprehensive IT services including website development, software
    solutions, digital marketing integration, and technical consulting. We
    help businesses improve efficiency, enhance online presence, and
    achieve digital transformation through modern technologies.
  </p>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
      ...
      <div className="max-w-[420px]">
        ...
        <p className="text-gray-800 text-lg mt-6 leading-9 max-w-md">
          With 6+ years of professional experience, Walshkon Consultants has
          successfully assisted thousands of clients across multiple sectors.
          Our commitment to quality, accuracy, and client satisfaction has made
          us a trusted consulting partner worldwide.
        </p>
      </div>
  ...
  <div className="max-w-6xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-gray-200 rounded-[28px] p-8 shadow-md">
        ...
        <div className="text-yellow-500 text-lg mb-5">
          ★ ★ ★ ★ ★
        </div>

        <p className="text-[#26374A] text-[16px] leading-8">
          “Walshkon Consultants handled my immigration and legal documentation
          with precision. Their team explained everything clearly and ensured a
          smooth and stress-free process. Truly reliable professionals.”
        </p>
      </div>
      ...
      <div className="bg-gray-200 rounded-[28px] p-8 shadow-md">
        ...
        <p className="text-[#26374A] text-[16px] leading-8">
          “I used Walshkon Consultants for recruitment and IT support. Their
          team was responsive, knowledgeable, and solution-oriented. I highly
          recommend them for professional consulting services.”
        </p>
      </div>
